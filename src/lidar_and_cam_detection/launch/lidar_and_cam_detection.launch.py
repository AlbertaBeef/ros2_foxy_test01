...
def generate_launch_description():
    ...
    # Launch Lidar and Camera processing node 
    lidar_and_cam_detection_node = Node(
        package='lidar_and_cam_detection',
        executable='lidar_and_cam_detection_node',
        output='screen'
    )
    
    # Launch ML task FPS Display nodes
    display_fps_cam_node = GroupAction(
        actions=[
    ...
    display_fps_lidar_node = GroupAction(
        actions=[
    ...
    return LaunchDescription([
        ...
        cv_cam_node,
        tf2_ros_node,
        lidar_and_cam_detection_node,
        display_fps_cam_node,
        display_fps_lidar_node
    ])
